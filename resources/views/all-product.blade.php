...
<header class="header bg-body">
    <nav class="navbar flex-nowrap p-0">
        <div class="navbar-brand-wrapper d-flex align-items-center col-auto">
            ...
            <a class="navbar-brand navbar-brand-mobile" href="http://172.8.180.66:8000/api/product-management">
...
<main class="main">
    ...
    <aside id="sidebar" class="js-custom-scroll side-nav">
        <ul id="sideNav" class="side-nav-menu side-nav-menu-top-level mb-0">
            <!-- Title -->
            <li class="sidebar-heading h6">Quản Lý Sản Phẩm</li>
            <!-- End Title -->
    ...
    <div class="card mb-3 mb-md-4">
        <div class="card-body">
            ...
            <div class="table-responsive-xl">
                <table class="table text-nowrap mb-0" id="productTable">
                    <thead>
                        <tr>
                            ...
                            <th class="font-weight-semi-bold border-top-0 py-2">Promotional Price</th>
                            <th class="font-weight-semi-bold border-top-0 py-2">Quantity</th>
                            <th class="font-weight-semi-bold border-top-0 py-2">File PDF</th>
                ...
                <div class="card-footer d-block d-md-flex align-items-center d-print-none">
                    <div class="d-flex mb-2 mb-md-0" id="paginationInfo">Showing 1 to 5 of 5 Entries</div>

                    <nav class="d-flex ml-md-auto d-print-none" aria-label="Pagination">
                        <ul class="pagination justify-content-end font-weight-semi-bold mb-0" id="paginationControls">
                            <li class="page-item disabled">
                                <a id="datatablePaginationPrev" class="page-link" href="#!" aria-label="Previous"><i class="gd-angle-left icon-text icon-text-xs d-inline-block"></i></a>
                            </li>
                            <li class="page-item active"><a class="page-link" href="#!" data-dt-page-to="0">1</a></li>
                            <li class="page-item disabled">
                                <a id="datatablePaginationNext" class="page-link" href="#!" aria-label="Next"><i class="gd-angle-right icon-text icon-text-xs d-inline-block"></i></a>
                            </li>
                        </ul>
                    </nav>
                </div>
...
<script>
    $(document).ready(function () {
        $.getJSON('http://172.8.180.66:8000/api/all-product', function (data) {
            if (data.status) {
                ...
                products.forEach((product, index) => {
                    const productRow = `
                        <tr>
                            ...
                            <td class="py-3">${product.promotional_price}</td>
                            <td class="py-3">${product.quantity}</td>
                            <td class="py-3">${product.pdf_file}</td>
                            <td class="py-3">
                ...
                $('#paginationInfo').text(`Showing 1 to ${products.length} of ${products.length} Entries`);
                $('#datatablePaginationNext').parent().addClass('disabled'); // Disable "Next" button if only one page
            } else {
        ...
        <footer class="small p-3 px-md-4 mt-auto">
            <div class="row justify-content-between">
                ...
                <div class="col-lg text-center text-lg-right">
                    &copy; 2024 Đề Tài Xây Dựng App Bán Sách. All Rights Reserved.
                </div>
            </div>
        </footer>
        <!-- End Footer -->
